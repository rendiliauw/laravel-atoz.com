            ...
            <div class="container">
                ...
                @if(\Auth::user())    
                    @if(\Auth::user()->level == 'USER')    
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('order.create')}}">Prepaid Balance</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('product.orderpage')}}">Product</a>
                        </li>
                    @else
                        ...
                        <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{route('prepaid.index')}}">
                                        Data Prepaid
                                    </a>
